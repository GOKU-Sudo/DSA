...
int maxValue(BTNode<int> *root)
{
    ...
    TreeNode* helperFunc(vector<int> inorder,vector<int> postorder,int inorderStart,int inorderEnd, int postorderStart,int postorderEnd){ // helper function to build tree from inorder and postorder traversal
    ...
    TreeNode* buildTree(vector<int>& inorder, vector<int>& postorder) { // main function to build tree from inorder and postorder traversal
